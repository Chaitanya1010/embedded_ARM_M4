...
{
		I2C0_MCR_R |= 0x00000031; // enabling 4th and 5th bits so that master, slave functions are enabled and the 0th bit for loopback
...
char receive_data_in_slave()
{
	char y;
//		while((I2C0_SCSR_R&0x01)!= 0x01) // wait for RREQ bit to become 1
//		{
//			;
//		}
//		// now the RREQ bit is 1
//		
//		while((I2C0_SCSR_R&0x04)!= 0x04) // wait for FBR bit to become 1
//		{
//			;
//		}
